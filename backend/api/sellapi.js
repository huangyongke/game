...
exports.findAllGames = function(req, res) {
	...
	sort = params.sort
	Sell.findAllGames(game,area,zone,startprice,endprice,sort,countPerPage,currentPage,function(result){
		res.send(result)
	})
}
...
exports.findAllSellGame = function(req, res) {
	...
	var recommend = req.body.recommend == 'undefined' ?  null : req.body.recommend
	Sell.findAllSellGame(sell_id,game_id,area_id,zone_id,category_id,state,recommend,function(result){
		res.send(result)
	})
}
